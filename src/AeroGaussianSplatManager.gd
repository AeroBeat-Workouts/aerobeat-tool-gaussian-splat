...
const BACKGROUND_LOADER_SCRIPT := preload("AeroGaussianSplatBackgroundLoader.gd")
const BACKGROUND_READ_WORKER_SCRIPT := preload("AeroGaussianSplatBackgroundReadWorker.gd")
